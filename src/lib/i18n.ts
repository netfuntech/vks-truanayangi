...
export const copy = {
  vi: {
    ...
    locationsDescription: 'Tất cả {count} cơ sở Net Vikings', openMap: 'Mở bản đồ', close: 'ĐÓNG', locationsNote: '', newBranch: 'Mới', comingSoon: 'Sắp mở', branchPage: 'Trang chi nhánh',
  ...
  en: {
    ...
    locationsDescription: 'All {count} Net Vikings locations', openMap: 'Open map', close: 'CLOSE', locationsNote: '', newBranch: 'New', comingSoon: 'Coming soon', branchPage: 'Branch page',
